...
with st.sidebar:
    ...
    st.header("👨‍💻 Developer")
    st.markdown("Developed with ❤️ by Aafi malek.")
...
def main():
    ...
    st.write(
        "**Welcome! Ever wondered how a computer sees the world? This tool gives you a glimpse.** "
        "Upload any image, and our advanced AI model will analyze its contents and generate a human-like descriptive caption. "
    ...
    with st.container(border=True):
        ...
        if uploaded_image:
            ...
            with col1:
                st.image(img_bytes, caption="Your Uploaded Image", use_container_width=True)
